...
from fixtape.errors import FixTapeError, NoActiveSessionError
from fixtape.generators.digest import normalize_digest_bucket


class IntelligenceMixin:
    """Cross-session intelligence: similarity, patterns, clusters, hotspots, playbooks, recipes, triage."""
